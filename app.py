...
# === GOOGLE CREDENTIALS WITH SCOPES ===
credentials_dict = json.loads(st.secrets["GOOGLE_SERVICE_ACCOUNT_JSON"])
base_creds = service_account.Credentials.from_service_account_info(credentials_dict)
scoped_creds = base_creds.with_scopes([
    "https://www.googleapis.com/auth/spreadsheets",
    "https://www.googleapis.com/auth/drive"
])

client = vision.ImageAnnotatorClient(credentials=scoped_creds)
